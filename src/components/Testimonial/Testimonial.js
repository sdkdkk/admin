...
const Testimonial = () => {
    ...
    return ( <
        ...
        >
        <
        p className = "error-msg" > { errors.sortOrder && errors.sortOrder.message } <
        /p> <
        /Form.Group> <
        Form.Group className = "mb-3"
        controlId = "formBasicEmail" >
        ...
        name = "profileimage"
        accept = ".png,.jpg,.jpeg,.tif,.tiff,.bmp,.gif,.ico" {...register("profileimage", {
        ...
        >
        <
        p className = "error-msg" > { errors.name && errors.name.message } <
        /p> <
        /Form.Group> <
        /div> <
        div className = "col-md-6" >
