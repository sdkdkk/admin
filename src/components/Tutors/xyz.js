...
const Coupon = () => {
    ...
    return ( <
        ...
        id = "hoursInput"
        name = "couponCode" {...register("couponCode", { required: true }) }
        /> {
            errors.couponCode && ( <
        ...
        className = "form-control me-2"
        id = "hoursInput"
        name = "discount" {...register("discount", { required: true }) }
        /> {
            errors.discount && ( <
                p className = "error text-right text-danger" >
        ...
        className = "form-control me-2"
        id = "hoursInput"
        name = "validityDate" {...register("validityDate", {
                required: true,
            })
        }
        /> {
        ...
        tbody > {
            conversionRate.map((data, index) => ( <
                ...
                td > { data.discount } < /td> <
                td > { data.validityDate ? new Date(data.validityDate).toISOString().substring(0, 10) : '-' } < /td> <
                td >
                <
