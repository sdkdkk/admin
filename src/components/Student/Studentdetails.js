    ...
    return ( <
...

        {
            Loader ? ( <
                ...
                style = {
                    { marginLeft: "500px", marginTop: "250px" } } > {
                    Loader ? ( <
                ...
                div className = "second-section text-center mt-4 mx-4" > {
                    studentdetail.map((data) => {
                        return ( <
                            ...
                            address >
                            1355 Market St, Suite 900 San Francisco, CA 94103 P: (123) 456 - 7890 <
                            /address> <
                            br / >
                            <
                        ...
                        return ( <
                            ...
                            td > { Data.tutor } {
                                clicked === index ? ( <
                                    ...
                                    <
                                    b > dateOfPosted < /b>:<Moment format="D MMM YYYY" withTitle> { Data.allQuestions.dateOfPosted } <
                                    /Moment> <
                                    /span> <
                                    span className = "list-group-item mt-2 " >
                                    <
